	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<a class = "btn btn-warning" href = "cancel.php"> Cancel Room</a>
				<a class = "btn btn-info disabled" > Cancel Hall</a>
				<br />
				<br />
  
  
  
    <center><h2> CANCEL YOUR HALL BOOKING</h2><br><br>
    <form action="cancel_hquery.php" method="post">
