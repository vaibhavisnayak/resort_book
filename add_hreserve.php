		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php 
					...
					$query = $conn->query("SELECT * FROM `hall` WHERE `hall_id` = '$_REQUEST[hall_id]'") or die(mysql_error());
				...
				<div class = "well col-md-4">
					<form method = "POST" enctype = "multipart/form-data">
						...
						<div class = "form-group">
							...
							<input type = "date" class = "form-control" name = "idate" required = "required" />
						</div>
						<br /><div class = "form-group">
							<label>Check out</label>
							<input type = "date" class = "form-control" name = "odate" required = "required" />
						</div><br>
					
					
						<div class = "form-group">
							<button class = "btn btn-info form-control" name = "add_hall"><i class = "glyphicon glyphicon-save"></i> Submit</button>
						</div>
					</form>
				</div>
				<div class = "col-md-4"></div>
				<?php require_once 'add_query_hreserve.php';
				?>
			</div>
		</div>
	</div>
